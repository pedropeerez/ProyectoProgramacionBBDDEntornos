...
public class Principal extends JFrame {
     ...
     */
    public <T> T executeDbOperation(DatabaseOperation<T> operation, String errorMessage, Component parent) {
    ...
    public void mostrarOpcionesVenta() {
    ...
    public void mostrarFormularioDatos(String opcion, String color) {
    ...
    public String getModeloFromProductId(int productId) {
    ...
    public boolean eliminarProducto(String modelo, String variante) {
